...
import com.tenondelabs.hack2017.di.modules.ActividadModule;
 ...
 */
//@Singleton @Component(modules = {MainModule.class, LibsModule.class, ActividadModule.class})
public interface ActividadComponent {
//    void inject(ActividadListFragment fragment);
}
